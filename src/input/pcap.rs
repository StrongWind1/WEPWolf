//! Phase 1 -- Ingest: classic pcap (all 10 magic variants) parser. See specs/02-architecture.md §3.1 + §8.1.
//!
...
pub struct PcapReader<R: Read> {
    ...
    /// a heap allocation per packet (~70 M allocs on a large capture).
    pkt_buf: Vec<u8>,
}
