//! Phase 1 -- Ingest: input format detection and reader dispatch (fully non-interactive, never blocks on stdin -- FR-IN-4). See specs/02-architecture.md §3.1.
//!
