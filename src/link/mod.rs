//! Phase 2 -- Decode: link-layer header dispatch by DLT -- strips Radiotap / PPI / Prism / AVS / SLL with tiered recovery (FR-PARSE-1). See specs/02-architecture.md §3.2.
//!
...
/// captures. See `specs/02-architecture.md §3.3` transport-vector inventory item 6.
#[must_use]
