//! Phase 2 -- Decode: radiotap radio header (DLT 127). See specs/02-architecture.md §3.2 + §8.2.
//!
...
/// be 0 -- but 1.57M frames in the wpa-sec dataset have `it_version = 43` (0x2B) from a
...
/// no real-world capture has demonstrated it (see `specs/02-architecture.md §3.3`
